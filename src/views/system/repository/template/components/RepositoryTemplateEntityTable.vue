...
<script lang="ts">
export default {
  name: "RepositoryTemplateEntityTable"
}
</script>
        ...
        >
          ...
          <el-table-column align="center" label="类型" prop="conflictStatus" width="120">
            <template #default="scope">
              <el-tag v-if="scope.row.modelType === 'decoder'" type="success">解码器</el-tag>
              <el-tag v-else-if="scope.row.modelType === 'template'" type="success">模板</el-tag>
