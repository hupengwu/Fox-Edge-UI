<script lang="ts">
export default {
  name: "RepositoryServiceFormHeader"
}
</script>
 ...
 */
onMounted(() => {
  componentTypeOptions.value.push({label: '服务', value: 'service'});
  componentTypeOptions.value.push({label: '内核', value: 'kernel'});
  componentTypeOptions.value.push({label: '系统', value: 'system'});
