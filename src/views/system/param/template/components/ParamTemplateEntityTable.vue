...
<template>
  ...
  >
    ...
    <el-table-column label="模板名称" min-width="120" prop="templateName"/>
    <el-table-column :formatter="getOptionLabel" label="模板类型" min-width="120" prop="templateType"/>
    <el-table-column label="模板参数" min-width="120" prop="taskParamJson" type="expand">
...
let dataState = reactive({
  ...
  // 实体数据
  entityList: [] as ParamTemplateItem[],
});
...
function handleQuery() {
  ...
  listParamTemplateEntityPages(dataState.queryParams).then(({data}) => {
