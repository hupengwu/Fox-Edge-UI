<script lang="ts">
export default {
  name: "PeriodRecordGroupEntityTable"
}
</script>
  ...
  >
    ...
    <el-table-column label="任务参数" min-width="120" prop="taskParamJson" type="expand">
      <template #default="props">
        <period-record-value-table ref="periodRecordValueTableRef" v-model:value="props.row.objectValue"
                                   @query="handleQuery"
        />
      </template>
    </el-table-column>
...
import PeriodRecordValueTable from './PeriodRecordGroupValueTable.vue';

const periodRecordValueTableRef = ref<any>(); // 这了的变量名称必须和<deviceRecord-edit-dialog>的ref值一样
