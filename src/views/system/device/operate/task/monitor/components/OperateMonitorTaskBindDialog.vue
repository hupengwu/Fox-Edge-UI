<script lang="ts">
export default {
  name: "OperateMonitorTaskBindDialog"
}
</script>
...
import {OperateMonitorTaskItem} from "@/api/device/operate/task/monitor/types";
...
let dataState = reactive({
  ...
  multiple: true,
  // 监控任务
  monitorTask: {} as OperateMonitorTaskItem,
  // 查询参数
...
function handleSubmit() {
  dataState.monitorTask.deviceIds = Array.from(dataState.deviceIds);
