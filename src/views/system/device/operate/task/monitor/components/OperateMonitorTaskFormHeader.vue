<script lang="ts">
export default {
  name: "OperateMonitorTaskFormHeader"
}
</script>
...
<template>
  <el-form ref="queryFormRef" :inline="true" :model="queryParams">
    <el-form-item>
      ...
      <el-button :icon="Link" type="warning" @click="handleBindDialog">绑定</el-button>
 ...
 * 修改设备对话框
 */
function handleBindDialog() {
  emit('binding', 'header', 'binding');
}
